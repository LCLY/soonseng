...
import './LargeImageViewerModal.scss';
/*components*/
...
interface LargeImageViewerModalProps {
...
type Props = LargeImageViewerModalProps;
 ...
 * @category Components
 */
const LargeImageViewerModal: React.FC<Props> = ({
  record,
  loading,
  tableName,
  galleryImages,
...
export default LargeImageViewerModal;
