...
type Props = BrandFormItemsProps;

const BrandFormItems: React.FC<Props> = ({ crud, antdForm, onFinish }) => {
  return (
    <>
      <Form
        form={antdForm}
      ...
      >
        ...
        {crud === 'update' && (
          <>
            <Form.Item hidden name="brandId" rules={[{ required: true }]}>
              <Input />
            </Form.Item>
          </>
        )}
