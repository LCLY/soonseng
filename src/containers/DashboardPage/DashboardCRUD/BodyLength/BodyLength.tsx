...
interface BodyLengthProps {}

type Props = BodyLengthProps & StateProps & DispatchProps;

const BodyLength: React.FC<Props> = () => {
  /* ================================================== */
  /*  state */
  /* ================================================== */
  ...
  return (
    <>
      ...
      <LayoutComponent activeKey="body_length">
        <section className="">
          <HeaderTitle>Body Length (Tail)</HeaderTitle>
          {/* ================== */}
          {/*       Table        */}
          {/* ================== */}
          TABLE HERE
...
export default connect(mapStateToProps, mapDispatchToProps)(BodyLength);
