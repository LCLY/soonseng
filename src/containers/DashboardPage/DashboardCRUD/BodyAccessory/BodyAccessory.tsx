...
interface BodyAccessoryProps {}

type Props = BodyAccessoryProps & StateProps & DispatchProps;

const BodyAccessory: React.FC<Props> = () => {
  /* ================================================== */
  /*  state */
  /* ================================================== */
  ...
  return (
    <>
      ...
      <LayoutComponent activeKey="body_accessory">
        <section className="">
          <HeaderTitle>Body Accessory (Tail)</HeaderTitle>
          {/* ================== */}
          {/*       Table        */}
          {/* ================== */}
          TABLE HERE
...
export default connect(mapStateToProps, mapDispatchToProps)(BodyAccessory);
