...
export const SET_TOGGLE_USER_ASSIGN = 'SET_TOGGLE_USER_ASSIGN';
/* -------------------------------------------------- */
// Users
/* -------------------------------------------------- */
...
export const GET_ALL_PERFORMANCE = 'GET_ALL_PERFORMANCE';
export const GET_ALL_PERFORMANCE_START = 'GET_ALL_PERFORMANCE_START';
export const GET_ALL_PERFORMANCE_SUCCEED = 'GET_ALL_PERFORMANCE_SUCCEED';
export const GET_ALL_PERFORMANCE_FAILED = 'GET_ALL_PERFORMANCE_FAILED';

export const GET_ALL_MECHANICS = 'GET_ALL_MECHANICS';
export const GET_ALL_MECHANICS_START = 'GET_ALL_MECHANICS_START';
export const GET_ALL_MECHANICS_SUCCEED = 'GET_ALL_MECHANICS_SUCCEED';
export const GET_ALL_MECHANICS_FAILED = 'GET_ALL_MECHANICS_FAILED';

export const GET_SPECIFIC_MECHANIC_PERFORMANCE = 'GET_SPECIFIC_MECHANIC_PERFORMANCE';
export const GET_SPECIFIC_MECHANIC_PERFORMANCE_START = 'GET_SPECIFIC_MECHANIC_PERFORMANCE_START';
export const GET_SPECIFIC_MECHANIC_PERFORMANCE_SUCCEED = 'GET_SPECIFIC_MECHANIC_PERFORMANCE_SUCCEED';
export const GET_SPECIFIC_MECHANIC_PERFORMANCE_FAILED = 'GET_SPECIFIC_MECHANIC_PERFORMANCE_FAILED';

export const GET_PERFORMANCE_INTAKE_DATA = 'GET_PERFORMANCE_INTAKE_DATA';
export const GET_PERFORMANCE_INTAKE_DATA_START = 'GET_PERFORMANCE_INTAKE_DATA_START';
export const GET_PERFORMANCE_INTAKE_DATA_SUCCEED = 'GET_PERFORMANCE_INTAKE_DATA_SUCCEED';
export const GET_PERFORMANCE_INTAKE_DATA_FAILED = 'GET_PERFORMANCE_INTAKE_DATA_FAILED';
